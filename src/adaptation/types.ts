...
export type ContentNode =
  ...
  | { type: 'custom_emoji'; customEmojiId: string; children: ContentNode[]; altText?: string; altTextError?: string; stickerSetId?: string; stickerSetName?: string; format?: 'static' | 'animated' | 'video' };
